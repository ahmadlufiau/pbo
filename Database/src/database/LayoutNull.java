...
conn = DriverManager.getConnection("jdbc:mysql://localhost/akademik","root","password");
	...
	Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/akademik","root","password");
